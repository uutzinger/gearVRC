...
class gearVRC:
    ...
    async def report(self):
        ...
        while not self.finish_up.is_set():
            ...
            self.logger.log(logging.INFO, 'Accel {:>10.3f}, {:>10.3f}, {:>10.3f}'.format(self.accX,self.accY,self.accZ))
            self.logger.log(logging.INFO, 'Mag   {:>10.3f}, {:>10.3f}, {:>10.3f}'.format(self.magX,self.magY,self.magZ))
            self.logger.log(logging.INFO, 'Gyro  {:>10.3f}, {:>10.3f}, {:>10.3f}'.format(self.gyrX,self.gyrY,self.gyrZ))
